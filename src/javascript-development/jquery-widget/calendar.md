...
redirect_from: /guides/v2.3/javascript-dev-guide/widgets/widget_calendar.html
---
...
The calendar widget's _global configuration_ is a set of default options that are applied when each calendar instance is initialized. It includes the following:
