...
redirect_from: /guides/v2.3/javascript-dev-guide/javascript/js_debug.html
functional_areas:
  - Testing
---
...
[using the inspect element define the id]: {{site.baseurl}}/static/images/fdg_js_debug1.png

[search the page source for the store.menu string]: {{site.baseurl}}/static/images/fdg_js_debug2.png

[assets fallback rules]: {{page.baseurl}}/frontend-development/themes/set-inheritance.html#theme-inherit-static
...
[assets fallback]: {{page.baseurl}}/frontend-development/themes/set-inheritance.html#theme-inherit-static
