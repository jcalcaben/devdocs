...
redirect_from: /guides/v2.3/javascript-dev-guide/javascript/js_practice.html
---
...
[page source search result]: {{site.baseurl}}/static/images/fdg_js_pr1.png

[`gallery.js`]: {{site.mage2100url}}lib/web/mage/gallery/gallery.js

[can be reached from the page source view or from the file system]: {{page.baseurl}}/javascript-development/core-concepts/custom-code.html#config_file

[requirejs config file]: {{site.baseurl}}/static/images/fdg_pr_2.png
