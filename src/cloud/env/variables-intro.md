...
functional_areas:
  - Cloud
  - Configuration
redirect_from: /guides/v2.3/cloud/env/variables-intro.html
---

{{site.data.var.ece}} enables you to assign environment variables to override configuration options:

* [ADMIN]({{page.baseurl}}/cloud/env/magento-commerce-variables.html)—variables override project ADMIN variables
...
You can set [ADMIN variables]({{page.baseurl}}/cloud/env/magento-commerce-variables.html)
...
* **`true`**—Enables on-demand HTML minification; does _not_ copy the `<magento_root>var/view_preprocessed` to the `<magento_root>/init/` directory at the end of the _build_ stage.
