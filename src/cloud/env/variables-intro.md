...
* [ADMIN]({{page.baseurl}}/cloud/env/magento-admin-variables.html)—variables override project ADMIN variables
...
You can set [ADMIN variables]({{page.baseurl}}/cloud/env/magento-admin-variables.html)
