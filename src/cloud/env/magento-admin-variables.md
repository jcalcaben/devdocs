...
functional_areas:
  - Cloud
  - Configuration
redirect_from: /guides/v2.3/cloud/env/environment-vars_magento.html
---
...
for the administrative user account and Admin panel. See [Set environment and project variables]({{page.baseurl}}/cloud/project/configure-project.html#project-conf-env-var).
