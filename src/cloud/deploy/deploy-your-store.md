...
You can fully push, merge, and deploy through the [Project Web Interface]({{page.baseurl}}/cloud/project/branch-management.html) or CLI commands through a terminal application.
