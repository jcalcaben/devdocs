...
redirect_from: /guides/v2.3/cloud/live/stage-prod-live.html
functional_areas:
  - Cloud
  - Deploy
---
...
You can fully push, merge, and deploy through the [Project Web Interface]({{page.baseurl}}/cloud/project/branch-management-ui.html) or CLI commands through a terminal application.
...
For detailed information of the process, see [Starter Develop and Deploy Workflow]({{page.baseurl}}/cloud/architecture/starter-develop-deploy-workflow.html).
...
For more information, see [SSH and sFTP]({{page.baseurl}}/cloud/env/environment-intro/ssh-access.html).
...
* [Protective block]({{page.baseurl}}/cloud/deploy/protective-block.html)
