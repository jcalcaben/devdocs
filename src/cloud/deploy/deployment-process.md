...
* [`.magento.app.yaml`]({{page.baseurl}}/cloud/configure/magento-app-yaml.html)—defines how to build and deploy Magento, including services, hooks, cron jobs, and more.
