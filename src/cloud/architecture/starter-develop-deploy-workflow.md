...
redirect_from: /guides/v2.3/cloud/basic-information/starter-develop-deploy-workflow.html
---

The {{site.data.var.ece}} includes a single Git repository with a master branch for the Production environment that can be branched to create Staging and Integration environments for testing and development work. You can have up to four active environments, including a `master` environment for your production server. See [Starter architecture]({{page.baseurl}}/cloud/architecture/starter-architecture.html) for an overview.
...
![Develop and deploy workflow]({{site.baseurl}}/static/images/cloud_workflow-starter.png)
...
![Branch from Master]({{site.baseurl}}/static/images/cloud_workflow-branching.png)
...
![Develop code and push to deploy]({{site.baseurl}}/static/images/cloud_workflow-push-code.png)
...
{{site.data.var.ece}} provides a set of two [Configuration Management]({{page.baseurl}}/cloud/configure/configuration-management.html) commands that export configuration settings from your environment into a file. These commands are only available for **{{site.data.var.ece}} 2.2 and later**.
...
![Generate configuration management file]({{site.baseurl}}/static/images/cloud_workflow-config-mgmt.png)
...
![Environment variables generate]({{site.baseurl}}/static/images/cloud_workflow-env-variables.png)

For more information, see [Configuration Management]({{page.baseurl}}/cloud/configure/configuration-management.html).
...
For instructions, see [Install optional sample data]({{page.baseurl}}/cloud/howto/install-sample-data.html).

![Install optional sample data]({{site.baseurl}}/static/images/cloud_workflow-sample-data.png)
...
![Pull and sanitize production data]({{site.baseurl}}/static/images/cloud_workflow-data-code-process.png)

{:.bs-callout .bs-callout-info}
Before pushing the data to another environment, you should consider sanitizing your data. You have a couple of options including [using support utilities]({{page.baseurl}}/configure/command-line/run-support-utilities.html) or developing a script to scrub out customer data.
...
To learn more, see [Deployment process]({{page.baseurl}}/cloud/deploy/deployment-process.html).

### Push to Staging and test {#staging}

You should always push all of your code in iterations to your Staging environment for full testing. The first time you use this environment, you will need to configure a few services including [Fastly]({{page.baseurl}}/cloud/cdn/cloud-fastly.html), [Blackfire Profiler]({{page.baseurl}}/cloud/configure/blackfire.html), and [New Relic APM]({{page.baseurl}}/cloud/project/new-relic.html). We also recommend configuring payment gateways, shipping, notifications, and other vital services with sandbox or testing credentials.
...
To learn more, see [Deploy your store]({{page.baseurl}}/cloud/deploy/deploy-your-store.html).
...
To learn more, check out [Go live and launch]({{page.baseurl}}/cloud/live/go-live-overview.html).
