...
functional_areas:
  ...
  - Setup
  - Configuration
redirect_from: /guides/v2.3/cloud/onboarding/onboarding-tasks.html
---
...
see [Create and manage users]({{page.baseurl}}/cloud/project/project-users.html).
...
in Pro and Starter plans, see [Starter Architecture]({{page.baseurl}}/cloud/architecture/starter-architecture.html) and [Pro Architecture]({{page.baseurl}}/cloud/architecture/pro-architecture.html).
...
![Use the Project Web Interface to manage environments]({{site.baseurl}}/static/images/cloud_project-access.png)

For details, see [Project Web Interface]({{page.baseurl}}/cloud/project/project-intro.html).
...
![All status on the page]({{site.baseurl}}/static/images/cloud_status.png)
...
* Copy the store URL from the [Project Web Interface]({{page.baseurl}}/cloud/project/project-intro.html)
...
and `ADMIN_PASSWORD`. See [Set environment and project variables]({{page.baseurl}}/cloud/project/configure-project.html#project-conf-env-var).
