...
functional_areas:
  - Cloud
redirect_from: /guides/v2.3/cloud/bk-cloud.html
---
...
[cloud benefits]: {{site.baseurl}}/static/images/cloud/CloudBenefits.svg

{: width="930px" height="305px"}

[cloud stack]: {{site.baseurl}}/static/images/cloud/CloudStack.png
