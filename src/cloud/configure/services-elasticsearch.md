...
functional_areas:
  ...
  - Setup
  - Search
redirect_from: /guides/v2.3/cloud/project/project-conf-files_services-elastic.html
---
...
Merge and deploy the code to set the configurations for Elasticsearch. For information on how these changes affect your environments, see [`services.yaml`]({{page.baseurl}}/cloud/configure/services-yaml.html).
