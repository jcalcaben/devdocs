...
| `cache:`         | Controls [caching for the route]({{page.baseurl}}/cloud/configure/caching.html).                                                                                            |
| `redirects:`     | Controls [redirect rules]({{page.baseurl}}/cloud/configure/redirects.html).                                                                                                 |
| `ssi:`           | Controls enabling of [Server Side Includes]({{page.baseurl}}/cloud/configure/server-side-includes.html).                                                                    |
...
See more information about [caching]({{page.baseurl}}/cloud/configure/caching.html).

## Redirects

As discussed in more detail in [Redirects]({{page.baseurl}}/cloud/configure/redirects.html), you can manage complex redirection rules, such as _partial redirects_:
