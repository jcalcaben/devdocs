...
* 2.1.4 and later merchants: Upgrade [MCC]({{page.baseurl}}/cloud/project/composer.html) to the latest version in your branch and deploy to your Integration environment. The MCC upgrade includes this patch. To upgrade a default unchanged MCC, you only need to run `composer update` in a terminal.
...
For details on MCC and the update command, see [Composer]({{page.baseurl}}/cloud/project/composer.html).
