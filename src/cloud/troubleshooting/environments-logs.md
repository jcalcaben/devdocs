...
functional_areas:
  - Cloud
  - Configuration
redirect_from: /guides/v2.3/cloud/trouble/environments-logs.html
---

This topic discusses how you can use logs to troubleshoot problems related to Magento Commerce [build hooks]({{page.baseurl}}/cloud/deploy/deployment-process.html#cloud-deploy-over-phases-build) and [deploy hooks]({{page.baseurl}}/cloud/deploy/deployment-process.html#cloud-deploy-over-phases-hook).
