...
functional_areas:
  ...
  - Configuration
  - Services
redirect_from: /guides/v2.3/cloud/trouble/redis-troubleshooting.html
---
...
* After testing completes, deploy your code to Staging and Production environments. For more information on deployments, see [Deploy your store]({{page.baseurl}}/cloud/deploy/deploy-your-store.html).
...
* 2.1.4 and later merchants: Upgrade [MCC]({{page.baseurl}}/cloud/basic-information/cloud-composer.html) to the latest version in your branch and deploy to your Integration environment. The MCC upgrade includes this patch. To upgrade a default unchanged MCC, you only need to run `composer update` in a terminal.
...
For details on MCC and the update command, see [Composer]({{page.baseurl}}/cloud/basic-information/cloud-composer.html).
