...
functional_areas:
  - Cloud
  - Configuration
redirect_from: /guides/v2.3/cloud/project/user-admin.html
---

{{site.data.var.ece}} enables you to administer users by assigning them one or more roles. A _role_ provides access and improves security in your project. Different roles are authorized to do different things with your applications, environments, and users. You can add and manage user accounts for the entire project and permissions per available environment.
...
* Project administrator (also referred to as _super user_) can change settings and execute actions on any environment, including creating and restoring snapshots.
...
2. Click the **Projects** tab as the following figure shows.
   ...
   ![Click the projects tab to access your Cloud project]({{site.baseurl}}/static/images/cloud_account_project.png)
...
4. Click the configure project button next to project name in the top navigation bar as the following figure shows.
   ...
   ![Configure the project]({{site.baseurl}}/static/images/cloud_project_gear.png)

5. In the right pane, click **Add Users**.

   ![Start creating users]({{site.baseurl}}/static/images/cloud_project-config.png)

6. Click **Add User**.

   ![Add users]({{site.baseurl}}/static/images/cloud_project-add-superuser.png)
