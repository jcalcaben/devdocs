...
group: cloud-guide
title: Composer
redirect_from: /guides/v2.3/cloud/reference/cloud-composer.html
functional_areas:
  - Cloud
  - Upgrade
---
...
Magento extension and module developers use the `composer.json` file to manage product installations and upgrades. See [Install, manage, and upgrade extensions]({{page.baseurl}}/cloud/howto/install-extensions.html).
...
During the [build phase]({{page.baseurl}}/cloud/deploy/deployment-process.html), the Cloud environment runs `composer install` on a fresh clone of your Git branch to retrieve the latest dependencies.
