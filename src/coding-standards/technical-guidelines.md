...
redirect_from: /guides/v2.3/coding-standards/technical-guidelines.html
functional_areas:
  - Standards
---
...
{
    public function \_\_construct(RedisSessionAdapter $sessionAdapter)
    {}
}
...
class SessionManager
{
    public function \_\_construct(SessionAdapterInterface $sessionAdapter)
    {}
}
{% endhighlight %}
...
15.10.2. SHOULD NOT directly pass user-submitted values to include_(), require_(), create_function(), fopen(), preg_replace()
...
[cli command naming guidelines]: {{page.baseurl}}/extension-development/core-concepts/cli-command/naming.html
