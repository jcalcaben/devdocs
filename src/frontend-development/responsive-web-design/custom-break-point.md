...
redirect_from: /guides/v2.3/frontend-dev-guide/responsive-web-design/rwd-breakpoints.html
functional_areas:
  - Frontend
---
...
* if your theme [inherits]({{page.baseurl}}/frontend-development/themes/set-inheritance.html) from the other, then copy the parent's `variables.less`.
