...
functional_areas:
  - Frontend
  - Theme
redirect_from: /guides/v2.3/frontend-dev-guide/themes/theme-overview.html
---

## Themes overview

A _theme_ is a component of Magento application which provides a consistent look and feel (visual design) for entire application area (for example, {% glossarytooltip 1a70d3ac-6bd9-475a-8937-5f80ca785c14 %}storefront{% endglossarytooltip %} or Magento admin) using a combination of custom templates, layouts, styles or images.
...
![Themes flow]({{site.baseurl}}/static/images/fdg/create_install_theme.png)

[inherit other required files from a parent theme]: {{page.baseurl}}/frontend-development/themes/set-inheritance.html
