...
functional_areas:
  - Frontend
  - Theme
redirect_from: /guides/v2.3/frontend-dev-guide/themes/theme-apply.html
---
...
5. If caching is enabled, [clear the cache](#theme-apply-clear).
...
3. In the configuration record corresponding to your store view, click **Edit**.
...
2. In Admin, go to **CONTENT** > **Design** > **Configuration**
3. In the configuration record corresponding to your store view, click **Edit**.
4. Expand the **Header** tab.
5. In the **Logo Image** field browse to the logo file saved in your file system.
6. Upload the file.
7. Optionally, specify the desired width, height, and the alternative text for the logo in the corresponding fields.
8. Click **Save Configuration** or **Save and Continue**.
9. If caching is enabled, [clear the cache](#theme-apply-clear).
10. To see your changes applied, reload the storefront pages.
...
[design configuration page]: {{site.baseurl}}/static/images/design_conf1.png

[design configuration page for a particular scope]: {{site.baseurl}}/static/images/fdg/applied_theme.png
