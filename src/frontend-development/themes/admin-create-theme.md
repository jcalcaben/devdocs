...
functional_areas:
  - Frontend
  - Theme
redirect_from: /guides/v2.3/frontend-dev-guide/themes/admin_theme_create.html
---
...
In the theme directory, add `theme.xml` containing at least the theme name and the parent theme name (if the theme [inherits]({{page.baseurl}}/frontend-development/themes/set-inheritance.html) from one). We recommend you to inherit from the default Magento Admin theme: `Magento/backend`.
...
See the [Make your theme a Composer package (optional)]({{page.baseurl}}/frontend-development/themes/create-theme.html#fedg_create_theme_composer)
...
If you want to use the file with other name and/or format, you need to additionally declare it as described in [Declaring theme logo]({{page.baseurl}}/frontend-development/themes/create-theme.html#logo_declare).
...
See the [Apply a custom Admin theme topic]({{page.baseurl}}/frontend-development/themes/admin-apply-theme.html).
