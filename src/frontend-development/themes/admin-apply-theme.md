...
functional_areas:
  - Frontend
  - Theme
redirect_from: /guides/v2.3/frontend-dev-guide/themes/admin_theme_apply.html
---
...
3. Update the components by running the [`bin/magento setup:upgrade`]({{page.baseurl}}/install/command-line/uninstall-reinstall.html#instgde-install-keep) command.
...
* [Command line configuration]({{page.baseurl}}/configure/command-line.html)
* [Uninstall or reinstall Magento: Optionally keeping generated files]({{page.baseurl}}/install/command-line/upgrade-database.html)
...
* [Uninstall a theme]({{page.baseurl}}/install/command-line/uninstall-theme.html)
