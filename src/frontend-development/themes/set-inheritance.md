...
redirect_from: /guides/v2.3/frontend-dev-guide/themes/theme-inherit.html
functional_areas:
  - Frontend
  - Theme
---
...
![]({{site.baseurl}}/static/images/inh-background1.jpg)
...
Once the Orange Winter theme is [applied]({{page.baseurl}}/frontend-development/themes/apply-theme.html), the new holiday image overrides the one from Orange, so on {% glossarytooltip 1a70d3ac-6bd9-475a-8937-5f80ca785c14 %}storefront{% endglossarytooltip %} the holiday background is visible.

![]({{site.baseurl}}/static/images/inh-background2.jpg)
...
![In the minishopping cart products are listed under the Go to Checkout button]({{site.baseurl}}/static/images/inherit_mini1.png)
...
![In the minishopping cart products are listed above the Go to Checkout button]({{site.baseurl}}/static/images/inherit_mini2.png)

You can find out what exactly code changes are required to perform this and other tasks in the [Illustration of customizing templates topic]({{page.baseurl}}/frontend-development/templates/sample-customization.html).
...
For more information about extending layout refer to the [Extend a layout]({{page.baseurl}}/frontend-development/layouts/extend.html) article.
