...
functional_areas:
  - Frontend
redirect_from: /guides/v2.3/frontend-dev-guide/layouts/layout-practice.html
---
...
The Orange theme [inherits]({{page.baseurl}}/frontend-development/themes/set-inheritance.html) from Blank, so by default the rendered header links look like following:
...
OrangeCo [applies the Luma theme]({{page.baseurl}}/frontend-development/themes/apply-theme.html). Using the approach described in [Locate templates, layouts, and styles]({{page.baseurl}}/frontend-development/themes/debug-theme.html) they find out that the original block responsible for displaying the header links is defined in
...
Other modules use this block to add their specific links to the header using the [referenceBlock]({{page.baseurl}}/frontend-development/layouts/xml-instructions.html#fedg_layout_xml-instruc_ex_ref) instruction. For example, see how links are added in the Customer module: [app/code/Magento/Customer/view/frontend/layout/default.xml#L10-L23]({{site.mage2100url}}app/code/Magento/Customer/view/frontend/layout/default.xml#L10-L23)

The Luma theme [moves]({{page.baseurl}}/frontend-development/layouts/xml-instructions.html#fedg_layout_xml-instruc_ex_mv) the `top.links` block to the new `customer` block in the extending layout file.  
...
So the following [extending]({{page.baseurl}}/frontend-development/layouts/extend.html) layout is added in the Orange theme:
...
To add quick basic styling and visual behavior to the "dropdown" menu, OrangeCo added  [\_extend.less]({{page.baseurl}}/frontend-development/css-quickstart/customize.html#simple_extend) to their theme with the following customizations:

* Redundant elements are hidden with CSS.
* The `.lib-dropdown()` mixin from [Magento UI library]({{page.baseurl}}/frontend-development/css/ui-library.html) was applied to the corresponding element.
...
[layout transform]: {{site.baseurl}}/static/images/layout_transform21.png

[layout screen1]: {{site.baseurl}}/static/images/layout_screen221.png

[layout screen2]: {{site.baseurl}}/static/images/layout_screen321.png
