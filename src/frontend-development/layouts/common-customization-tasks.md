...
functional_areas:
  - Frontend
redirect_from: /guides/v2.3/frontend-dev-guide/layouts/xml-manage.html
---
...
![]({{site.baseurl}}/static/images/layout_image1.png)
...
![]({{site.baseurl}}/static/images/layout_image2.png)
...
[page configuration]: {{page.baseurl}}/frontend-development/layouts/file-types.html#layout-types-conf

[remove it]: {{page.baseurl}}/frontend-development/layouts/xml-instructions.html#fedg_layout_xml-instruc_ex_rem
...
[locate templates, layouts, and styles]: {{page.baseurl}}/frontend-development/themes/debug-theme.html
...
[`<block>`]: {{page.baseurl}}/frontend-development/layouts/xml-instructions.html#fedg_layout_xml-instruc_ex_block

[`<referenceblock>`]: {{page.baseurl}}/frontend-development/layouts/xml-instructions.html#fedg_layout_xml-instruc_ex_ref

[`<argument>`]: {{page.baseurl}}/frontend-development/layouts/xml-instructions.html#argument

[`<action>`]: {{page.baseurl}}/frontend-development/layouts/xml-instructions.html#fedg_layout_xml-instruc_ex_act

[`<move>` instruction]: {{page.baseurl}}/frontend-development/layouts/xml-instructions.html#fedg_layout_xml-instruc_ex_mv

[`before` and `after` attributes of `<block>`]: {{page.baseurl}}/frontend-development/layouts/xml-instructions.html#fedg_xml-instrux_before-after
