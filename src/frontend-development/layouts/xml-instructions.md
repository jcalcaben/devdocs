...
functional_areas:
  - Frontend
redirect_from: /guides/v2.3/frontend-dev-guide/layouts/xml-instructions.html
---
...
[page layout]: {{page.baseurl}}/frontend-development/layouts/file-types.html#layout-types-page

[page configuration]: {{page.baseurl}}/frontend-development/layouts/file-types.html#layout-types-conf

[generic layout]: {{page.baseurl}}/frontend-development/layouts/file-types.html#layout-types-gen

[handle]: {{page.baseurl}}/frontend-development/layouts.html#handle

[templates]: {{page.baseurl}}/frontend-development/templates.html
