...
functional_areas:
  - Frontend
  - Theme
redirect_from: /guides/v2.3/frontend-dev-guide/css-topics/theme-ui-lib.html
---
...
[inherits]: {{page.baseurl}}/frontend-development/themes/set-inheritance.html

[less]: http://lesscss.org/

[magento naming convention for the less variables]: {{page.baseurl}}/coding-standards/less.html#naming

[magento ui library documentation]: https://magento-devdocs.github.io/magento2-ui-library/

[ui_lib1.png]: {{site.baseurl}}/static/images/ui_lib1.png

[ui_lib2.png]: {{site.baseurl}}/static/images/ui_lib2.png
