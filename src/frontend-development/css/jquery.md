...
functional_areas:
  - Frontend
redirect_from: /guides/v2.3/frontend-dev-guide/css-topics/css-jquery.html
---

## What's in this topic

This topic provides an overview of how jQuery UI styles are used in Magento out of the box, and how you can use them in a custom {% glossarytooltip d2093e4a-2b71-48a3-99b7-b32af7158019 %}theme{% endglossarytooltip %}.
...
* [Define what styles you need to change]({{page.baseurl}}/frontend-development/themes/debug-theme.html#debug-theme-style)
* [Quick start guide to working with styles for a new theme]({{page.baseurl}}/frontend-development/css-quickstart.html)
