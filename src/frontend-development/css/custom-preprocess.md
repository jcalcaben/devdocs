...
functional_areas:
  - Frontend
redirect_from: /guides/v2.3/frontend-dev-guide/css-topics/custom_preprocess.html
---
...
For details about creating a module refer to the [Magento PHP Developer Guide]({{page.baseurl}}/extension-development.html).
...
3. If in your custom preprocessor, the syntax of the importing directives is different from `@import` and `@magento_import`, you must implement custom processor classes. 
...
* [Magento PHP Developer Guide]({{page.baseurl}}/extension-development.html)
