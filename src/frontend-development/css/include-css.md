...
title: Include CSS
redirect_from: /guides/v2.3/frontend-dev-guide/css-topics/css-themes.html
functional_areas:
  - Frontend
  - Theme
---
...
The recommended way to do this is adding an [extending]({{page.baseurl}}/frontend-development/layouts/extend.html) `default_head_blocks.xml` in your theme, and including the required stylesheets in this file.
...
[layout files]: {{page.baseurl}}/frontend-development/layouts.html

[theme directory]: {{page.baseurl}}/frontend-development/themes/structure.html
