...
functional_areas:
  - B2B
  - Integration
redirect_from: /guides/v2.3/b2b/integrations.html
---

This topic lists the REST endpoints and services that are provided with {{site.data.var.b2b}}. See [List of REST endpoints by module]({{page.baseurl}}/rest/quick-reference/list-rest-endpoints.html) and [List of service names by module]({{page.baseurl}}/rest/quick-reference/rest-service-names.html) for the endpoints and services that Magento {{site.data.var.ee}} and {{site.data.var.ce}}.
...
[List of service names by module]({{page.baseurl}}/rest/quick-reference/rest-service-names.html)
