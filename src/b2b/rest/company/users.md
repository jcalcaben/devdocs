...
functional_areas:
  - B2B
  - Integration
redirect_from: /guides/v2.3/b2b/company-users.html
---
...
This topic discusses only the features of the `customerCustomerRepositoryV1` service that are specific to B2B. See [Create a customer]({{page.baseurl}}/rest/tutorials/orders/create-customer.html) for an example of creating a standard customer.
