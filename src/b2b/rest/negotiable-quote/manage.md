...
functional_areas:
  - B2B
  - Integration
redirect_from: /guides/v2.3/b2b/negotiable-manage.html
---
...
Use the `PUT /V1/negotiableQuote/:quoteId` call to update a quote. See [Update a negotiable quote]({{page.baseurl}}/b2b/rest/negotiable-quote/update.html) for use cases.
