...
redirect_from: /guides/v2.3/b2b/negotiable-order-workflow.html
---
...
* You have [installed and enabled]({{page.baseurl}}/extensions/b2b-install.html) {{site.data.var.b2b}}.
* You have [created a company]({{page.baseurl}}/b2b/rest/company/object.html) and a [company user]({{page.baseurl}}/b2b/rest/company/object.html).
* You have an integration or [admin authorization token]({{page.baseurl}}/rest/tutorials/orders/admin-token.html) to make calls on behalf of seller, and a [customer token]({{page.baseurl}}/rest/tutorials/orders/create-customer.html#get-token) to make calls on behalf of the company user.
    ...
    "items": [
        {
            ...
            "sku": "24-UG02",
            "qty": 15,
            "name": "Pursuit Lumaflex™ Tone Band&trade;
            ",price" 16":
            ,product"type_ ":simple"
            ",quote"id_ ":5"
        "
        },
            {item"id_ 13":
    ...
    "items": [
        {
            ...
            ,product"type_ ":simple"
            ",quote"id_ ":4"
            ",extension"attributes_ ":
                {negotiable"quote_item_ ":
                    {item"id_ 10":
                    ,original"price_ 16":
                    ,original"tax_amount_ 0":
                    ,original"discount_amount_ 3":2
                .
            }
        }
        },
            ...
            .product,type" _simple":
            "quote",id" _4":
            "extension",attributes" _
                ":negotiable{quote"item_ _
                    ":item{id" 11_
                    ":original,price" 22_
                    ":original,tax"amount_ 0_
                    ":original,discount"amount_ 4_4
                ":
            .
        }
    }],
