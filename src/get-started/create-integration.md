...
redirect_from: /guides/v2.3/get-started/create-integration.html
---
...
* [Magento REST or SOAP Web APIs]({{page.baseurl}}/get-started/get-started.html)
* [Web API authentication]({{page.baseurl}}/get-started/authentication.html)
...
1. **Create the module file structure.** The module for an integration can be placed anywhere under the Magento root directory, but the recommended location is `<magento_base_dir>/vendor/<vendor_name>/module-<module_name>`.
   ...
   For more detailed information, see [Create your component file structure]({{page.baseurl}}/extension-development/build-tasks/file-structure.html).
...
* Ask for a request token. A request token is a temporary token that the user exchanges for an access token. Use the following API to get a request token from Magento:
  ...
  See [Get a request token]({{page.baseurl}}/get-started/authentication/oauth.html#pre-auth-token) for more details about this call.
...
* Ask for a access token. The request token must be exchanged for an access token. Use the following API to get a request token from Magento:
  ...
  See [Get an access token]({{page.baseurl}}/get-started/authentication/oauth.html#get-access-token) for more details about this call.
...
* [Create the module file structure]({{page.baseurl}}/extension-development/build-tasks/file-structure.html)
* [Create a component]({{page.baseurl}}/extension-development/build-tasks/name.html)
