...
redirect_from: /guides/v2.3/get-started/gs-web-api-request.html
---
...
Run the web API call through a [cURL command]({{page.baseurl}}/get-started/rest/use-curl.html) or a REST client.
