...
redirect_from: /guides/v2.3/migration/migration-tool-configure.html
---
...
The Data Migration Tool uses _mapping files_ to enable you to perform custom database mapping between your Magento 1 and Magento 2 databases, including:
...
You can refer to [ Data Migration Tool Technical Specification]({{page.baseurl}}/migration/overview/specifications.html) for more details.

## Next step

[Migrate using data migration tool]({{page.baseurl}}/migration/use-migration-tool/settings.html)
