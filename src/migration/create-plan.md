...
redirect_from: /guides/v2.3/migration/migration-plan.html
functional_areas:
  - Tools
---
...
[magento system requirements]: {{page.baseurl}}/install/getting-started/system-requirements.html

[magento marketplace]: https://marketplace.magento.com

[technical specification]: {{page.baseurl}}/migration/overview/specifications.html

[configuration guide]: {{page.baseurl}}/configure/command-line/manage-indexers.html
