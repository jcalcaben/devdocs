...
functional_areas:
  - Tools
redirect_from: /guides/v2.3/migration/migration-overview-practices.html
---
...
* **Follow our [General Rules for Successful Migration]({{page.baseurl}}/migration/use-migration-tool.html)** to avoid issues or conflicts.
