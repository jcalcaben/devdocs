...
redirect_from: /guides/v2.3/extension-dev-guide/build/create_component.html
---
...
* Create a [file structure]({{page.baseurl}}/extension-development/build-tasks/file-structure.html).
* Create the [configuration files]({{page.baseurl}}/extension-development/build-tasks/configuration-files.html) you'll need.
* [Register]({{page.baseurl}}/extension-development/build-tasks/register.html) your component.
...
* If a component has `composer.json` _and_ the component was installed using {% glossarytooltip d85e2d0a-221f-4d03-aa43-0cda9f50809e %}Composer{% endglossarytooltip %} (including from packagist, the Magento Marketplace, or other source), the Component Manager can update, uninstall, enable, or disable the component.
* If the component has `composer.json` but was _not_ installed using Composer (for example, custom code a developer wrote), Component Manager can still enable or disable the component.
...
* `type` determines what the {% glossarytooltip 3425e9ae-5edf-4fc6-b645-06023e9e5e5b %}Magento component{% endglossarytooltip %} type. Choose from _magento2-theme_, _magento2-language_, or _magento2-module_.
