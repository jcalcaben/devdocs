...
redirect_from: /guides/v2.3/extension-dev-guide/code-generation.html
---
...
[production mode]: {{page.baseurl}}/configure/application-initialization/magento-modes.html#production-mode

[instantiating objects with factories]: {{page.baseurl}}/extension-development/class-types/factory.html
