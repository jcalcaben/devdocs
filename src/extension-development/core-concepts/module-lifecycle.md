...
redirect_from: /guides/v2.3/extension-dev-guide/prepare/lifecycle.html
---
...
_Note:_ Theme and language package extensions do not need initialization or uninstallation tasks because they do not install database schemas or update data.
...
[component manager]: {{page.baseurl}}/system-update-upgrade/component-manager/uninstall.html
