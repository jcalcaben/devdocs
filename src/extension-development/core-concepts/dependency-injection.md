...
redirect_from: /guides/v2.3/extension-dev-guide/depend-inj.html
---
...
* [ObjectManager]({{page.baseurl}}/extension-development/core-concepts/dependency-injection/object-manager.html)
...
* [Magento application initialization and bootstrap]({{page.baseurl}}/configure/application-initialization.html)
* [Module Dependencies]({{page.baseurl}}/architecture/components/modules/dependencies.html)
* [Programming concepts]({{page.baseurl}}/extension-development/core-concepts/public-interfaces-api.html)
...
[code compiler tool]: {{page.baseurl}}/configure/command-line/compile-code.html

[proxies]: {{page.baseurl}}/extension-development/class-types/proxy.html

[proxy]: {{page.baseurl}}/extension-development/class-types/proxy.html

[factories]: {{page.baseurl}}/extension-development/class-types/factory.html

[interceptors]: {{page.baseurl}}/extension-development/class-types/plugin.html
