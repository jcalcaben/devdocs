...
redirect_from: /guides/v2.3/extension-dev-guide/declarative-schema/migration-commands.html
---
...
* See [Configure declarative schema]({{page.baseurl}}/extension-development/core-concepts/database-schema.html) if you need to make manual modifications to your schema.
