...
functional_areas:
  ...
  - Theme
  - Standards
redirect_from: /guides/v2.3/ext-best-practices/storefront/storefront-best-practices.html
---

The {% glossarytooltip 1a70d3ac-6bd9-475a-8937-5f80ca785c14 %}storefront{% endglossarytooltip %} theme is the front facing interface for a Magento application that can be customized through a [theme extension]({{page.baseurl}}/Delete). We suggest adopting the following best practices to avoid common problems we have seen other developers make while making a {% glossarytooltip d2093e4a-2b71-48a3-99b7-b32af7158019 %}theme{% endglossarytooltip %} {% glossarytooltip 55774db9-bf9d-40f3-83db-b10cc5ae3b68 %}extension{% endglossarytooltip %}.
...
* [Clear directories during development]({{page.baseurl}}/extension-development/build-tasks/clear-directories.html)
...
* [How to make your theme responsive and mobile]({{page.baseurl}}/frontend-development/responsive-web-design.html)
...
* [Theme inheritance]({{page.baseurl}}/frontend-development/themes/set-inheritance.html)
