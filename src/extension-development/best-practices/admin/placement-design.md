...
functional_areas:
  - Standards
redirect_from: /guides/v2.3/ext-best-practices/admin/placement-and-design.html
---
...
For more information about icon design and Magento's icon library, see the article about  [Iconography]({{page.baseurl}}/design-style/iconography.html) in the Admin Style Guide book.
...
_The names for the types of extensions listed below are for reference purposes only._
...
![Connector settings placement]({{site.baseurl}}/static/images/ext-best-practices/connector-settings-placement.png)
...
![Store Feature Connector placement]({{site.baseurl}}/static/images/ext-best-practices/store-feature-connector-placement.png)
...
![Connector with additional features placement]({{site.baseurl}}/static/images/ext-best-practices/additional-feature-placement.png)
...
![Feature Placement]({{site.baseurl}}/static/images/ext-best-practices/feature-placement.png)
