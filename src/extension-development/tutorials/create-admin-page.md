...
functional_areas:
  - Standards
redirect_from: /guides/v2.3/ext-best-practices/extension-coding/example-module-adminpage.html
---
...
For more information see: [`composer.json`]({{page.baseurl}}/extension-development/files/composer-json.html).
...
For more information see: [registering your component]({{page.baseurl}}/extension-development/build-tasks/register.html).
...
For more information see: [naming your component]({{page.baseurl}}/extension-development/build-tasks/name.html).
...
For more information on this topic, see: [routing]({{page.baseurl}}/extension-development/core-concepts/routing.html).
...
![Hello World menu item]({{site.baseurl}}/static/images/ext-best-practices/hello-world-menu-item.png)
...
Inside `Controller/Adminhtml/HelloWorld` directory, create the file `Index.php`. This file is the class assigned to the default Index action for the `HelloWorld` controller. Since the admin area serves this page, the file belongs in the `Adminhtml` directory, and the class itself extends [`\Magento\Backend\App\Action`]({{site.mage2100url}}app/code/Magento/Backend/App/Action.php).
...
The name of this file uses the following pattern: _frontName_\__controller_\__action_.xml
...
![Hello World Page]({{site.baseurl}}/static/images/ext-best-practices/hello-world-page.png)
