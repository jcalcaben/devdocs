...
group: cloud-guide
title: Git
redirect_from: /guides/v2.3/cloud/reference/git-integration.html
---
...
* [Manage branches with the Project Web Interface]({{page.baseurl}}/cloud/project/branch-management-ui.html)
* [Manage branches with the CLI]({{page.baseurl}}/cloud/env/environment-overview.html)
...
When setting up your SSH, review our information at [SSH and sFTP]({{page.baseurl}}/cloud/env/environment-intro/ssh-access.html).
...
To integrate other Git repositories with your {{site.data.var.ece}} project using GitHub or Bitbucket deploy keys, refer to [Pull code from a private Git repository]({{page.baseurl}}/cloud/project/branch-management-ui.html#private).
