...
redirect_from: /guides/v2.3/bk-get-started-magento.html
functional_areas:
  - Integration
---
...
For more information, see our [Contributors Guide]({{page.baseurl}}/remove).

## Contact us {#contact-us}

Feel free to contact the documentation team directly at
<mailto:DL-Magento-Doc-Feedback@magento.com>

#### Related topics

* [Release Notes]({{page.baseurl}}/release-notes.html)
* [Architecture Guide]({{page.baseurl}}/architecture.html)
