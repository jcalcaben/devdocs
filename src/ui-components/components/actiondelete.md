...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-actiondelete.html
---

## Overview

The ActionDelete component provides a user interface for deleting records of the [DynamicRows component]({{page.baseurl}}/ui-components/components/dynamicrows.html).
