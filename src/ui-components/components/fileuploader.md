...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-fileuploader.html
---
...
Here is an example of how File Uploader component integrates with [Form]({{page.baseurl}}/ui-components/components/form.html) component:
