...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-massactions.html
---

The MassActions component allows performing actions with multiple selected items. Must be a child of the [Listing component]({{page.baseurl}}/ui-components/components/listing.html).

See the [Admin Design Pattern Library (MassActions)]({{page.baseurl}}/pattern-library/data-display/data-table.html#massactions) topic for information about the UI design patterns that can be implemented using the MassActions component.
