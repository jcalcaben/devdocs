...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-radioset.html
---

The Radioset component is a shortcut for [Checkboxset]({{page.baseurl}}/ui-components/components/checkboxset.html), with the input type set to the radio button.
