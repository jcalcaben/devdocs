...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-filters.html
---

The Filters component renders UI controls for filtering and applies filtering. Must be a child of the [Listing component]({{page.baseurl}}/ui-components/components/listing.html).

See the [Admin Design Pattern Library (Filters)]({{page.baseurl}}/pattern-library/data-display/data-table/filter.html) topic for information about the UI design patterns that can be implemented using Filters component.
