...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-date.html
---

The Date component implements a custom date input field. It uses a date picker implementation provided by the [calendar widget]({{page.baseurl}}/javascript-development/jquery-widget/calendar.html).
