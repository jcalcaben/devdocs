...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-treemassactions.html
---

The TreeMassActions component is a decorator for [MassActions]({{page.baseurl}}/ui-components/components/massactions.html) that adds the support of nested actions.
...
Extends [`MassActions`]({{page.baseurl}}/ui-components/components/massactions.html):
