...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-wysiwyg.html
---

The WYSIWYG component is an {% glossarytooltip edb42858-1ff8-41f9-80a6-edf0d86d7e10 %}adapter{% endglossarytooltip %} for [TinyMCE v4](https://www.tinymce.com/) that integrates an editor instance with the [form component]({{page.baseurl}}/ui-components/components/form.html). It expects a complete {% glossarytooltip f0dcf847-ce21-4b88-8b45-83e1cbf08100 %}widget{% endglossarytooltip %} declaration in the `content` option, which should contain both {% glossarytooltip 8f407f13-4350-449b-9dc5-217dcf01bc42 %}markup{% endglossarytooltip %} and the script responsible for creating the editor's instance.
...
<code>value</code>
    ...
    <td>[Links]({{page.baseurl}}/ui_comp_guide/concepts/ui_comp_linking_concept.html) the component's <code>value</code> property with the provider, using the path that is declared in the <code>dataScope</code> property.</td>
...
See [Events and observers]({{page.baseurl}}/extension-development/class-types/observer.html) to learn more about events and how to use them.
...
Last, add your data provider, controller, and routes. Refer to [Creating a Magento admin page]({{page.baseurl}}/extension-development/tutorials/create-admin-page.html) for more information.
...
{: .bs-callout .bs-callout-info }
Refer to [About PHP modifiers in UI components]({{page.baseurl}}/ui-components/concepts/php-modifiers.html) for more information.
...
{: .bs-callout .bs-callout-info }
If your form already uses the [ModifierPool]({{page.baseurl}}/ui-components/concepts/php-modifiers.html), you can continue using it to control the configuration of your WYSIWYG components.
