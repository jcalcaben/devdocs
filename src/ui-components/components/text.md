...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-text.html
---

The Text component displays text data in the components like [Form]({{page.baseurl}}/ui-components/components/form.html) and [DynamicRows]({{page.baseurl}}/ui-components/components/dynamicrows.html).
