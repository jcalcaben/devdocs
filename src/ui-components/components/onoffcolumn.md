...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-onoffcolumn.html
---

The OnOffColumn component is a decorator for [MultiselectColumn]({{page.baseurl}}/ui-components/components/multiselectcolumn.html). It displays toggle switch elements instead of checkboxes.
...
Extends [`MultiselectColumn`]({{page.baseurl}}/ui-components/components/multiselectcolumn.html):
