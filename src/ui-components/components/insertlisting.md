...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-insertlisting.html
---

The InsertListing component inserts [Listing]({{page.baseurl}}/ui-components/components/listing.html) into other components.
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      Here <code>link</code> means the two-way [
      links property]({{page.baseurl}}/ui_comp_guide/concepts/ui_comp_linking_concept.html#links) of UI components, which allows immediate
      update.
    </td>
    <td>
      Boolean
