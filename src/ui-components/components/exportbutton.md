...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-exportbutton.html
---
...
* Add configuration data to ExportButton definition [`Magento/Ui/view/base/ui_component/etc/definition.xml`]({{page.baseurl}}/ui-library/ui-definition.html)
