...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-file.html
---
...
<table>
  ...
  <tr>
    ...
    <td>
      [
      Links]({{page.baseurl}}/ui_comp_guide/concepts/ui_comp_linking_concept.html) the component's <code>value</code> property with
