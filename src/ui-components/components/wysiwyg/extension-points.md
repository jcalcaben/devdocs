...
redirect_from: /guides/v2.3/ui_comp_guide/components/wysiwyg/extension-points/index.html
---
...
[virtual type]: {{page.baseurl}}/extension-development/files/di-xml.html#virtual-types

[`di.xml`]: {{page.baseurl}}/extension-development/files/di-xml.html

[integrate third-party editors]: {{page.baseurl}}/ui-components/components/wysiwyg.html#add-a-custom-editor
