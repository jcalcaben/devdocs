...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-listing-grid.html
---

Listing is a [basic component]({{page.baseurl}}/ui-components.html#general-structure) that implements grids, lists, and tiles with filtering, pagination, sorting, and other features.
    ...
    <argument name="data" xsi:type="array">
        ...
        <item name="buttons" xsi:type="array">
            <item name="add" xsi:type="array">
                ...
                <item name="url" xsi:type="string">_/_/new</item>
            </item>
        </item>
    </argument>
</listing>
