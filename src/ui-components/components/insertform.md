...
redirect_from: /guides/v2.3/ui_comp_guide/components/ui-insertform.html
---

The InsertForm component inserts the [Form component]({{page.baseurl}}/ui-components/components/form.html) into other components.
