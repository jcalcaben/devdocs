...
redirect_from: /guides/v2.3/ui_comp_guide/components/basic-attributes.html
---

## Overview

This topic describes the general UI components configuration attributes. There's a set of attributes available for all UI components, and a set of attributes which are specific for [basic components]({{page.baseurl}}/ui-components.html#general-structure) only. 
...
<table>
  ...
  <tr>
    ...
    <td>The path in the [registry]({{page.baseurl}}/ui_comp_guide/concepts/ui_comp_uiregistry.html) to the linked data provider.</td>
    <td>String</td>
  </tr>
</table>
