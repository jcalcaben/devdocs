...
functional_areas:
  - Checkout
redirect_from: /guides/v2.3/howdoi/checkout/checkout_edit_form.html
---
...
[Set Magento to the developer mode]({{page.baseurl}}/configure/command-line/set-magento-mode.html) when performing all customizations and debugging.
