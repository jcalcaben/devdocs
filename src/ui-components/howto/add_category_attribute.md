...
redirect_from: /guides/v2.3/ui_comp_guide/howto/add_category_attribute.html
---
...
[Upgrade the database schema]({{page.baseurl}}/install/command-line/upgrade-database.html) to install the attribute [and clear your cache]({{page.baseurl}}/extension-development/build-tasks/clear-directories.html#howdoi-clear-how).
