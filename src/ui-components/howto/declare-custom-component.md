...
redirect_from: /guides/v2.3/ui_comp_guide/howto/new_component_declaration.html
---
...
[uielement]: {{page.baseurl}}/ui-components/concepts/uielement-class.html

[uicollection]: {{page.baseurl}}/ui-components/concepts/uicollection-class.html

[use the "arbitrary" structure]: {{page.baseurl}}/ui-components/best-practices/semantic-config.html#info_structure_except

[basic ui component]: {{page.baseurl}}/ui-components.html#general-structure

[about xml сonfiguration of ui сomponents]: {{page.baseurl}}/ui-components/concepts/xml-configuration.html#about-the-layout-configuration-file-and-ui-component-declaration
