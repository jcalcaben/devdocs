...
redirect_from: /guides/v2.3/ui_comp_guide/concepts/ui_comp_xmldeclaration_concept.html
---
...
For more information about the configuration flow, refer to  the [Configuration Flow of UI Components]({{page.baseurl}}/ui-components/concepts/configuration-flow.html) topic.
