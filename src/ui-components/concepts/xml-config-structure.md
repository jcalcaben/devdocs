...
redirect_from: /guides/v2.3/ui_comp_guide/concepts/ui_comp_xmlconfig_structure.html
---
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      [
      Basic attributes]({{page.baseurl}}/ui_comp_guide/components/basic-attributes.html).
    </td>
    <td>
      <ol>
        <li>
    ...
    <td>
      ...
      basic UI component]({{page.baseurl}}/ui_comp_guide/bk-ui_comps.html#general-structure): <code>&lt;form&gt;</code>,
  ...
  <tr>
    ...
    <td>
      Introduces the configuration block for UiComponent according
      to the [
      new structure]({{page.baseurl}}/ui_comp_guide/best-practices/semantic_config.html). Use for configuring all options, except
