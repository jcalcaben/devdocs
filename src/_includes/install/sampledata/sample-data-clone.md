...
3.  Click **Copy to clipboard**
    ...
    <img src="{{site.baseurl}}/static/images/install_mage2_clone-ssh.png" width="650px" alt="Clone the Magento GitHub repository using SSH">
...
3.  Click **Copy to clipboard**.
    ...
    <img src="{{site.baseurl}}/static/images/install_mage2_clone-https.png" width="650px" alt="Clone the Magento GitHub repository using HTTPS">
