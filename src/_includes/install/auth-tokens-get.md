...
3.  Click **Access Keys** in the Marketplace tab.
	...
	![Get your secure access keys on Magento Marketplace]({{site.baseurl}}/static/images/cloud_access-key.png){:width="500px"}
...
3.	Click **Account Settings** > **Downloads Access Token**.
	...
	![Access your keys]({{site.baseurl}}/static/images/connect_keys1.png){:width="200px"}
