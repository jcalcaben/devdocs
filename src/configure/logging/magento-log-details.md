...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/config-guide/log/log-magento.html
---
...
To start working with a logger, you must get a `\Psr\Log\LoggerInterface` instance. One way to do that is illustrated in our [database logging example]({{page.baseurl}}/configure/logging/database-activity-example.html).
...
[Example—logging database activity]({{page.baseurl}}/configure/logging/database-activity-example.html)
