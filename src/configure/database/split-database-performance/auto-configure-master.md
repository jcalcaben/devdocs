...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/config-guide/multi-master/multi-master_masterdb.html
---
...
3. Configuring {{site.data.var.ee}} to use the checkout and sales databases
