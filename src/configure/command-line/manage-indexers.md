...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/config-guide/cli/config-cli-subcommands-index.html
---
...
This command reindexes one time only. To keep indexers up-to-date, you must set up a [cron job]({{page.baseurl}}/configure/command-line/cron.html#config-cli-cron-bkg).
...
[Learn more about indexing]({{page.baseurl}}/extension-development/core-concepts/indexers.html)
...
* [Generate data for performance testing]({{page.baseurl}}/configure/command-line/generate-data-for-performance-testing.html)
