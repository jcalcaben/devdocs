...
functional_areas:
  ...
  - Setup
redirect_from: >-
  /guides/v2.3/config-guide/cli/config-cli-subcommands-static-deploy-strategies.html
---

## Overview

When [deploying static view files]({{page.baseurl}}/configure/command-line/static-content/deploy.html), you can choose one of the three available strategies. Each of them provides optimal deployment results for different use cases:
...
For more information, see [Deploy static view files]({{page.baseurl}}/configure/command-line/static-content/deploy.html).
