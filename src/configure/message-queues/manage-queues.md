...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/config-guide/mq/manage-mysql.html
---
...
_/app/code/Magento/MessageQueue/etc/crontab.xml_
...
Edit _/app/etc/env.php_ file for configure cron job `consumers_runner`
...
* [Command-line configuration]({{page.baseurl}}/configure/command-line/getting-started.html)
* [Message Queues]({{page.baseurl}}/extension-development/core-concepts/message-queues.html)
