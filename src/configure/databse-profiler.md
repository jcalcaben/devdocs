...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/config-guide/db-profiler/db-profiler.html
---
...
![Sample database profiler results]({{site.baseurl}}/static/images/config_db-profiler-results.png)
