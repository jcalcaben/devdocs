...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/config-guide/varnish/tshoot-varnish-503.html
---
...
For more information about using the command line, see [Get started with command-line configuration]({{page.baseurl}}/configure/command-line/getting-started.html).
