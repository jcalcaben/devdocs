...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/config-guide/redis/redis-pg-cache.html
---
...
You must  [install Redis]({{page.baseurl}}/configure/caching/redis.html#config-redis-install) before continuing.
