...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/config-guide/redis/redis-session.html
---

## Prerequisite {#reds-cache-prereq}

If Redis will be used for default or page caching, you must [install Redis]({{page.baseurl}}/configure/caching/redis.html#config-redis-install) before continuing. .
