...
functional_areas:
  - Integration
redirect_from: /guides/v2.3/rest/list.html
---
...
See [Integrate with B2B using REST]({{page.baseurl}}/b2b/rest.html) for a list of endpoints provided with {{site.data.var.b2b}}.
