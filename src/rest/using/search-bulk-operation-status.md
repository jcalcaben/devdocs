...
functional_areas:
  - Integration
redirect_from: /guides/v2.3/rest/operation-status-search.html
---
...
* `status` - The operation status:
  ...
  * `4` = Open
  * `5` = Rejected
* `bulk_uuid` - UUID generated by an [asynchronous API request]({{page.baseurl}}/rest/using/asynchronous-endpoints.html) or [Bulk API request]({{page.baseurl}}/rest/using/bulk-endpoints.html).
...
See [Search using REST APIs]({{page.baseurl}}/rest/using/search.html) for more information about the syntax of search requests.
