...
redirect_from: /guides/v2.3/test/integration/integration_test_execution.html
functional_areas:
  - Testing
  - test
---
...
![Integration Test Class run configuration]({{site.baseurl}}/static/images/phpstorm_run_config_class_integration_tests.png)
...
[phpstorm run]: {{page.baseurl}}/testing/unit/phpstorm.html
