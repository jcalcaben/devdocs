...
redirect_from: /guides/v2.3/mtf/create_test/create_new_test.html
---
...
![A new Synonym fixture]({{site.baseurl}}/static/images/ftf/mtf_tut_fixt.png)
...
![New Synonym Group page]({{site.baseurl}}/static/images/ftf/mtf_tutorial_new_syn_ui.png)
...
![ScopeID data source alternative from Magento_Widget]({{site.baseurl}}/static/images/ftf/mtf_tutorial_storeIds-widget.png)
...
![Synonym ScopeID data source location]({{site.baseurl}}/static/images/ftf/mtf_tutorial_datasource.png)
...
In this example it is named `CreateSynonymEntityTest.php` and stored in `<magento2_root_dir>/dev/tests/functional/tests/app/Magento/Search/Test/TestCase`.
 ...
 ![A test case location]({{site.baseurl}}/static/images/ftf/mtf_tutorial_testcase_location.png)
...
![Created data set]({{site.baseurl}}/static/images/ftf/mtf_tutor_dataset.png)
...
![Created pages]({{site.baseurl}}/static/images/ftf/mtf_tutorial_pages.png)
...
![PHP classes of pages]({{site.baseurl}}/static/images/ftf/mtf_tutorial_pages_php.png)
...
![New Synonym Group page]({{site.baseurl}}/static/images/ftf/mtf_tutorial_page_new_synonym.png)
...
![Block structure in a code base]({{site.baseurl}}/static/images/ftf/mtf_tutorial_block_struct.png)

The `Search/Test` directory in functional tests should be constructed in a similar manner:

![Block structure in a functional test]({{site.baseurl}}/static/images/ftf/mtf_tutorial_block_struct_test.png)
...
![Form mapping block]({{site.baseurl}}/static/images/ftf/mtf_tutorial_block_mapping.png)
...
![Message about the successful save]({{site.baseurl}}/static/images/ftf/mtf_tutorial_success_message.png)
...
![A constraint location]({{site.baseurl}}/static/images/ftf/mtf_tutorial_constraint_dir.png)
...
[install one]: {{page.baseurl}}/install/methods/git.html
...
[data source]: {{page.baseurl}}/testing/functional-testing-framework/entities/fixture.html#mtf_fixture_source
...
[test case topic]: {{page.baseurl}}/testing/functional-testing-framework/entities/test-case.html
...
[blocks]: {{page.baseurl}}/testing/functional-testing-framework/entities/block.html

[block mapping]: {{page.baseurl}}/testing/functional-testing-framework/entities/block.html#mtf_block_mapping

[learn about form mapping.]: {{page.baseurl}}/testing/functional-testing-framework/entities/block.html#mtf_block_mapping

[define a locator]: {{page.baseurl}}/testing/functional-testing-framework/entities/block.html#define-selector

[nodes description table]: {{page.baseurl}}/testing/functional-testing-framework/entities/block.html#mtf_block_form_xml_nodes

[page]: {{page.baseurl}}/testing/functional-testing-framework/entities/page.html

[pages]: {{page.baseurl}}/testing/functional-testing-framework/entities/page.html

[page topic]: {{page.baseurl}}/testing/functional-testing-framework/entities/page.html

[constraint]: {{page.baseurl}}/testing/functional-testing-framework/entities/constraint.html

[custom typified element]: {{page.baseurl}}/testing/functional-testing-framework/entities/typified-element.html#magento_class

[adjust a configuration]: {{page.baseurl}}/testing/functional-testing-framework/quick-start/configuration-setting.html

[prepare magento application]: {{page.baseurl}}/testing/functional-testing-framework/quick-start/magento-setting.html

[prepare environment for test run]: {{page.baseurl}}/testing/functional-testing-framework/quick-start/environment-setting.html

[`generatefixturexml.php`]: {{page.baseurl}}/testing/functional-testing-framework/entities/fixture.html#mtf_fixture_create

[set data to a fixture field]: {{page.baseurl}}/testing/functional-testing-framework/entities/data-set.html#fixture_field

[set data to a fixture field from a repository]: {{page.baseurl}}/testing/functional-testing-framework/entities/data-set.html#fixture_field_repository

[`%isolation%` placeholder]: {{page.baseurl}}/testing/functional-testing-framework/entities/fixture-repository.html#mtf_repo_isolation
...
[`\magento\backend\test\block\gridpageactions`]: {{site.mage2000url}}dev/tests/functional/tests/app/Magento/Backend/Test/Block/GridPageActions.php

[`\magento\backend\test\block\formpageactions`]: {{site.mage2000url}}dev/tests/functional/tests/app/Magento/Backend/Test/Block/GridPageActions.php
...
[`\magento\backend\test\block\formpageactions`]: {{site.mage2000url}}dev/tests/functional/tests/app/Magento/Backend/Test/Block/FormPageActions.php

[`\magento\customer\test\constraint\assertcustomersuccesssavemessage`]: {{site.mage2000url}}dev/tests/functional/tests/app/Magento/Customer/Test/Constraint/AssertCustomerSuccessSaveMessage.php

[up and running]: {{page.baseurl}}/testing/functional-testing-framework/quick-start/environment-setting.html#mtf_quickstart_env_selenium
