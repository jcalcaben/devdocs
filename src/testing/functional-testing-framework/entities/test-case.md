...
title: Test case
redirect_from: /guides/v2.3/mtf/mtf_entities/mtf_testcase.html
---
...
![Test case flow diagram]({{site.baseurl}}/static/images/ftf/mtf_test_case_flow.png)

## How to create a test case {#how-to-create}

**Step 1.** Create a [data set][]

**Step 2.** Create a {% glossarytooltip bf703ab1-ca4b-48f9-b2b7-16a81fd46e02 %}PHP{% endglossarytooltip %} class in the `<magento2_root_dir>/dev/tests/functional/tests/app/Magento/<module>/TestCase` directory
...
**Step 4.** If you have preconditions, prepare the data using a [\_\_prepare()](#prepare-method) method

**Step 5.** Inject the initial data for a test using a [\_\_inject()](#inject-method) method

**Step 6.** Declare all the test steps in the [test()](#test-method) method

**Step 7.** If you want to perform any actions after constraints, use a [tearDown()](#teardown-method) method
...
[mtf\testcase\injectable]: https://github.com/magento/mtf/blob/develop/Magento/Mtf/TestCase/Injectable.php

[scenario test]: {{page.baseurl}}/testing/functional-testing-framework/entities/scenario-test.html

[processassert()]: {{page.baseurl}}/testing/functional-testing-framework/entities/constraint.html#mtf_constraint_assert
...
[magento\catalog\test\testcase\product\updatesimpleproductentitytest]: {{site.mage2000url}}dev/tests/functional/tests/app/Magento/Catalog/Test/TestCase/Product/UpdateSimpleProductEntityTest.php
