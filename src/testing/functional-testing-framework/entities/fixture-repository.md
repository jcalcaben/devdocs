...
redirect_from: /guides/v2.3/mtf/mtf_entities/mtf_fixture-repo.html
---
...
[More details about fixtures]({{page.baseurl}}/testing/functional-testing-framework/entities/fixture.html).
...
![cms_page_link "Settings" data set for entire fixture view on GUI]({{site.baseurl}}/static/images/ftf/mtf_ent_fixt_repo_cms_set_ui.png)
...
![cms_page_link "Storefront properties" data set for entire fixture view on GUI]({{site.baseurl}}/static/images/ftf/mtf_ent_fixt_repo_cms_set_ui_storefront.png)
...
![cms_page_link "Frontend App Options" data set for entire fixture view on GUI]({{site.baseurl}}/static/images/ftf/mtf_ent_fixt_repo_cms_set_ui_frontend-app.png)
...
In brief, we reference another repository `<magento2>/dev/tests/functional/tests/app/Magento/Widget/Test/Repository/Widget/WidgetOptions.xml`, and a [source]({{page.baseurl}}/testing/functional-testing-framework/entities/fixture.html#mtf_fixture_source) that is `<magento2>/dev/tests/functional/tests/app/Magento/Widget/Test/Fixture/Widget/WidgetOptions.php`.
...
![all_pages data set view on GUI]({{site.baseurl}}/static/images/ftf/mtf_repository_layout-allpages_w_dropd.png)
...
![on_category data set view on GUI]({{site.baseurl}}/static/images/ftf/mtf_repository_layout-oncategory_w_dropd.png)
...
![layout_for_cms_page_link data set view on GUI]({{site.baseurl}}/static/images/ftf/mtf_repository_layout-for-cms-page-link_w_dropd.png)
...
The configuration repository stores predefined data sets for Magento configuration settings. It is the repository for the [Magento_Config module]({{site.mage2000url}}app/code/Magento/Config) and is named `ConfigData.xml`.
...
![authorizenet data set view on GUI]({{site.baseurl}}/static/images/ftf/mtf_ent_fixt_repo_config_scope-id.png)
...
![authorizenet data set view on GUI]({{site.baseurl}}/static/images/ftf/mtf_repo_config_ex.png)
...
[![]({{site.baseurl}}/static/images/ftf/mtf_repo_merge_ex.png)]({{site.baseurl}}/static/images/ftf/mtf_repo_merge_ex.png)
