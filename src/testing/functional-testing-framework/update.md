...
redirect_from: /guides/v2.3/mtf/mtf_update.html
---
...
Step 3.    [Perform and check installation.]({{page.baseurl}}/testing/functional-testing-framework/installation.html#mtf_install_perform)
