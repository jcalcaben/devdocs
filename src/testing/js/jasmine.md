...
functional_areas:
  - Testing
  - test
redirect_from: /guides/v2.3/test/js/jasmine.html
---
...
[deploy static view files]: {{page.baseurl}}/configure/command-line/static-content/deploy.html#config-cli-subcommands-xlate-dict
