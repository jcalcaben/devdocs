...
redirect_from: /guides/v2.3/howdoi/customize-modifier-class.html
---

[Modifier classes]({{page.baseurl}}/ui-components/concepts/php-modifiers.html) should be used when static declaration is not applicable. For example, in cases when additional data should be loaded from database. Also, modifier is a place where you add validations to display only certain fields for certain product types.
