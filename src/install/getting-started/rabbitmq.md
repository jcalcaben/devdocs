...
A basic message queue system can be implemented using cron instead of RabbitMQ. See [Configure message queues]({{page.baseurl}}/configure/message-queues/manage-queues.html) for more information.
