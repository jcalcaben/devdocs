...
* Continue with the next prerequisite ([PHP Ubuntu]({{page.baseurl}}/install/getting-started/php/centos-ubuntu.html#php-for-ubuntu))
...
To enable web site visitors to access your site, use one of the [Require directives](http://httpd.apache.org/docs/2.4/howto/access.html).
...
To enable web site visitors to access your site, use the [Allow directive](http://httpd.apache.org/docs/2.2/mod/mod_authz_host.html#allow).
