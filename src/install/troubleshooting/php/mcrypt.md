...
redirect_from: /guides/v2.3/install-gde/trouble/php/tshoot_mcrypt.html
functional_areas:
  - Install
  - System
  - Setup
...
In some cases, you might need to install the Magento software from the [command line]({{page.baseurl}}/install/command-line.html) and specify the full path to the LAMP stack that has mcrypt installed.
