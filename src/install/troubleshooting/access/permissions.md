...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/install-gde/trouble/tshoot_var-gen-perms.html
---
...
[enable developer mode]({{page.baseurl}}/configure/command-line/set-magento-mode.html#change-to-developer-mode) to see the exceptions.
...
Review our recommendations in [Overview of ownership and permissions]({{page.baseurl}}/install/getting-started/file-system-ownership-permissions.html).
