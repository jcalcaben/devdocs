...
redirect_from: /guides/v2.3/contributor-guide/contributing_dod.html
---
...
[0]: {{page.baseurl}}/coding-standards/general-docblock.html

[1]: {{page.baseurl}}/architecture/back-compatibility.html

[2]: {{page.baseurl}}/testing/testing.html

[3]: {{page.baseurl}}/testing/integration/test-execution.html
