...
2. In your repository, click **Pull requests** on the right, and then click **New pull request**. <br><img src="{{site.baseurl}}/static/images/pr.png" target="_blank">
...
5. Create a pull request from `<your-fork>:up-port-pull-13528` to m`agento:2.3-develop`.
...
1. In the Magento 2 public repository, click the **Issues** link on the right. <br><img src="{{site.baseurl}}/static/images/issues.png" alt="the Issues link at the right"/>
2. Click **New issue**.<br><img src="{{site.baseurl}}/static/images/new_issue.png" alt="the New Issue button"/>
