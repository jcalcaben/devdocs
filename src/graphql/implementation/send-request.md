...
redirect_from: /guides/v2.3/graphql/send-request.html
---
...
<p>An integration, admin, or customer token. See [Token-based authentication]({{page.baseurl}}/get-started/authentication/gs-authentication-token.html) for more information.</p>
</td>
</tr>
<tr>
