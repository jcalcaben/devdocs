...
redirect_from: /guides/v2.3/graphql/develop/create-custom-url-resolver.html
---
...
See [Events and observers]({{page.baseurl}}/extension-development/class-types/observer.html) for more information about creating an observer.
