...
functional_areas:
  - Integration
redirect_from: /guides/v2.3/payments-integrations/base-integration/formblocktype.html
---
...
`formBlockType` is one of the arguments you must [configure for the payment method facade]({{page.baseurl}}/payment-integration/core-concepts/facade-configuration.html). 
