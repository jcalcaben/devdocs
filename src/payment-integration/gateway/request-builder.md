...
redirect_from: /guides/v2.3/payments-integrations/payment-gateway/request-builder.html
---
...
Builder composites are added using [dependency injection]({{page.baseurl}}/extension-development/core-concepts/dependency-injection.html) in `di.xml`. A builder composite might comprise simple builders as well as other builder composites.
