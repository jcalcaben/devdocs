...
redirect_from: /guides/v2.3/payments-integrations/payment-gateway/response-validator.html
---
...
A payment provider integration can have multiple response validators, that should be added to the provider's validator's pool using [dependency injection]({{page.baseurl}}/extension-development/core-concepts/dependency-injection.html).
