...
functional_areas:
  - Integration
redirect_from: /guides/v2.3/payments-integrations/vault/enabler.html
---
...
Now when we have information about enabling or disabling vault, the payment must send it to the payment processor. This is done in the [request builder]({{page.baseurl}}/payment-integration/gateway/request-builder.html). 
...
[Storing and processing the payment related data]({{page.baseurl}}/payment-integration/vault/payment-token.html)
