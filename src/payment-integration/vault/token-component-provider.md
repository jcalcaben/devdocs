...
functional_areas:
  - Integration
redirect_from: /guides/v2.3/payments-integrations/vault/token-ui-component-provider.html
---
...
[Display stored tokens for customer and process their deleting]({{page.baseurl}}/payment-integration/vault/stored-information.html).
