...
title: Wizard
redirect_from: /guides/v2.3/pattern-library/navigation/wizard/wizard.html
---
...
![]({{page.baseurl}}/pattern-library/navigation/images/wizard/structure-wizard.jpg)
...
![]({{page.baseurl}}/pattern-library/navigation/images/wizard/pattern-styles.jpg)
...
![]({{page.baseurl}}/pattern-library/navigation/images/wizard/pattern-behavior.jpg)
...
![]({{page.baseurl}}/pattern-library/navigation/images/wizard/variation-1.1.png)

![]({{page.baseurl}}/pattern-library/navigation/images/wizard/variation-1.2.png)

In the last step, next button is disabled.

![]({{page.baseurl}}/pattern-library/navigation/images/wizard/variation-1.3.png)
...
![]({{page.baseurl}}/pattern-library/navigation/images/wizard/variation-3.1.png)

Any other steps, Save button is present. Both 'Back' and 'Next' buttons are enabled.

![]({{page.baseurl}}/pattern-library/navigation/images/wizard/variation-3.2.png)

'Next' button becomes disabled. The user will use 'Save' button for saving.

![]({{page.baseurl}}/pattern-library/navigation/images/wizard/variation-3.3.png)
...
![]({{page.baseurl}}/pattern-library/navigation/images/wizard/variation-4.png)
