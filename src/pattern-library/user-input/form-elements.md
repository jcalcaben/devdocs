...
title: Form Elements
redirect_from: >-
  /guides/v2.3/pattern-library/getting-user-input/form_elements/form_elements.html
---
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/form-sample-horizontal.png)

**Example of label-left**

![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/form-sample-vertical.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/required.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/focus.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/grid-horizontal.png)

**Grid and label-top form**

![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/grid-vertical.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/text-field.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/add-field.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/resize-field.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/field-checkbox.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/date-pick.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/trigger.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/checkboxes.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/tri-check.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/radios.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/dropdown.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/list-box.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/attribute-selector.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/validation.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/disabled.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/units.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/masking.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/read.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/disclosure.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/contextual-help.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/help-text.png)
...
![]({{page.baseurl}}/pattern-library/user-input/images/form-elements/spec-sample.png)

## Accessibility

Follow this guideline: <http://www.w3.org/TR/WCAG10-HTML-TECHS/#forms>.
