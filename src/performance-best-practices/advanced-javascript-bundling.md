...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/performance-best-practices/advanced-js-bundling.html
---
...
![noBundling]({{page.baseurl}}/performance-best-practices/images/noBundling.png)
...
![bundlingImage]({{page.baseurl}}/performance-best-practices/images/bundlingImage.png)
...
![magentoBundling]({{page.baseurl}}/performance-best-practices/images/magentoBundling.png)
...
![magentoMergingRealWorld]({{page.baseurl}}/performance-best-practices/images/magentoMergingDevWorld.png)
...
![magentoBundlingRealWorld]({{page.baseurl}}/performance-best-practices/images/magentoBundlingRealWorld.png)
...
![magentoMergingRealWorld]({{page.baseurl}}/performance-best-practices/images/magentoMergingRealWorld.png)
...
Later, we will change the `optimize:` setting from\_ `none` to `uglify2` to minify bundle output. But for now, during development, you can leave it set to `none` to  ensure faster builds.
...
![RequireJSConfig]({{page.baseurl}}/performance-best-practices/images/RequireJSConfig.png)
...
![TwiceAsFast]({{page.baseurl}}/performance-best-practices/images/TwiceAsFast.png)
...
![ThreeTimesFaster]({{page.baseurl}}/performance-best-practices/images/ThreeTimesFaster.png)
