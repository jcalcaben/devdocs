...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/performance-best-practices/advanced-setup.html
---
...
[Split database performance solution]({{page.baseurl}}/configure/database/split-database-performance.html).
