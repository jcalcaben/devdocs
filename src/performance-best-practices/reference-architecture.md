...
functional_areas:
  ...
  - System
  - Setup
redirect_from: /guides/v2.3/performance-best-practices/reference-architecture.html
---
...
For {{site.data.var.ece}} environments, see [Starter architecture]({{page.baseurl}}/cloud/architecture/starter-architecture.html).
