...
To get Fastly credentials, open a [support ticket]({{page.baseurl}}/cloud/troubleshooting/troubleshooting-intro.html).
...
for [Support]({{page.baseurl}}/cloud/troubleshooting/troubleshooting-intro.html) asking to have the
...
3. In the right pane, expand **Full Page Cache**.
   ...
   ![Expand to select Fastly]({{site.baseurl}}/static/images/cloud_fastly_menu.png)
...
entering your [Support ticket]({{page.baseurl}}/cloud/troubleshooting/troubleshooting-intro.html) for
