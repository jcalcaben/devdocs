...
functional_areas:
  - Integration
  - Orders
redirect_from: /guides/v2.3/rest/tutorials/prerequisite-tasks/create-admin-token.html
---
...
See [Token-based authentication]({{page.baseurl}}/get-started/authentication/token.html) for more information about authorization tokens.
