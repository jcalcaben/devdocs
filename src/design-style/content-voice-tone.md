...
functional_areas:
  - Content
redirect_from: /guides/v2.3/design-styleguide/content-voice-tone/content-voice-tone.html
---
...
To ensure that users with special needs – including the use of screen readers – can easily access your content, follow the content and design standards in the Admin Design Pattern Library's [Accessibility Guidelines]({{page.baseurl}}/pattern-library/general/accessibility-guidelines.html).
...
* _First reference:_ The Associated Press (AP) Stylebook

* _Second reference:_ Microsoft Manual of Style, specifically these chapters:
...
Use the "zombie test" – if you can put the words “by zombies” after a subject and verb, you’re using passive voice. _Passive-voice example:_ “Magento is used (by zombies)”
...
_Exception:_ “You” or “your” neutral pronouns may be used in some cases to directly engage merchants in familiar, conversational language.
...
Consistency is critical. For example, wherever content is displayed in [Data Tables]({{page.baseurl}}/pattern-library/data-display/data-table.html) or [Form Elements]({{page.baseurl}}/pattern-library/user-input/form-elements.html), it should use Magento standard or global conventions.
<br>

_Correct example of button-label consistency, in a task flow:_
...
_Incorrect example of button-label consistency, in a task flow:_
...
_For more details,_ see [Button and Links Usage standards]({{page.baseurl}}/design-style/buttons-links-usage.html).
<br><br>
...
_For more details,_ see [Errors and Messages Writing standards]({{page.baseurl}}/design-style/errors-and-messages.html).
