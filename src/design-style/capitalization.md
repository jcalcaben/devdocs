...
redirect_from: /guides/v2.3/design-styleguide/capitalization/capitalization.html
---
...
* The [Acronyms]({{page.baseurl}}/design-style/content-formats.html#acronyms) section in Content Formats.

* The [Address]({{page.baseurl}}/design-style/content-formats.html#addresses) section in Number Formats.
...
* **Numbered items.** Capitalize when referring to a numbered object. ... _Correct examples:_ Slide 5, Exercise 3, Table 4.2, Figure 9
...
* **Global internet terms.** ... _Correct examples:_ website, internet, online, email
