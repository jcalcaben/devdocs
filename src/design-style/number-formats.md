...
redirect_from: /guides/v2.3/design-styleguide/number-formats/number-formats.html
---
...
See [Addresses]({{page.baseurl}}/design-style/content-formats.html#addresses) section in Content Formats.

## Percentages

In regular text, write out “percent”. However, the ”%” sign can be used in call-outs, graphics, and large-format content (_Example:_ posters).
...
Do not add a space between the symbol and the number. ... _Examples:_ $781, £490, €2,183
...
* Do not abbreviate months of the year when they appear by themselves or with a year. ... _Correct example:_ "September 2015"."
...
* Months:
  ...
  * _Abbreviations to use:_ Jan., Feb., Aug., Sept., Oct., Nov., Dec.

* Never abbreviate ...

  * Days of the week ... _Correct example:_ Use "Wednesday", not "Weds.".

  * Years ... _Correct example:_ Use "2017", not "'17".
...
* _Date-range format, in a sentence:_ The conference runs Sept. 8-12, 2017.
...
* Formatting. When a time is not adjusted by the system to reflect the current time zone, append the time zone after the time. ... _Correct examples:_ "7:30am CT", "7-10:30am CT"

* Do not indicate standard or daylight time. ... _Correct example:_ Central Time is written as "CT", not "CST" or "CDT".

* Do not use military time. ... _Incorrect example:_ Using 19:40, instead of 7:40pm.
