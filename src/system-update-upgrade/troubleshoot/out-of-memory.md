...
functional_areas:
  - Upgrade
redirect_from: /guides/v2.3/comp-mgr/trouble/cman/out-of-memory.html
---
...
First, make sure you allocated [2GB of memory to PHP]({{page.baseurl}}/install/getting-started/php/settings.html); otherwise, your installation or upgrade might still run out of memory.
