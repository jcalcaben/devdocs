...
title: Service layer
redirect_from: /guides/v2.3/architecture/archi_perspectives/service_layer.html
---
...
This is implemented using _service contracts_, which are defined using {% glossarytooltip bf703ab1-ca4b-48f9-b2b7-16a81fd46e02 %}PHP{% endglossarytooltip %} interfaces.
...
* Data (or _entity_) interfaces in the `Api/Data` directory ([Catalog API/Data][catalog-api-data]).
...
This is done using the _&lt;preference>_ element in a custom module's {% glossarytooltip 2be50595-c5c7-4b9d-911c-3bf2cd3f7beb %}dependency injection{% endglossarytooltip %} configuration file (`di.xml`) file.
