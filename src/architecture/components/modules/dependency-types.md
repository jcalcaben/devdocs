...
A module with a _hard dependency_ on another module cannot function without the module it depends on. These modules:
...
A module with a _soft dependency_ on another module can function properly without the other module, even if they have a dependency upon it. These modules:
