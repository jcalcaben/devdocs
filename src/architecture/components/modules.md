...
See [PHP Developer Guide]({{page.baseurl}}/extension-development.html) for specific instructions on extending modules 

See [Frontend Developer Guide]({{page.baseurl}}/frontend-development.html) for information on implementing themes and other components.

## Related topics {#arch-modules-related}

[Module dependencies]({{page.baseurl}}/architecture/components/modules/dependencies.html)

[Modules and areas]({{page.baseurl}}/architecture/components/modules/areas.html)

[Module location and naming conventions]({{page.baseurl}}/architecture/components/modules/conventions.html)
