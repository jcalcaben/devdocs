...
redirect_from: /guides/v2.3/architecture/archi_perspectives/arch_diagrams.html
---
...
[Magento architecture layers]({{site.baseurl}}/static/images/archi_diagrams_layers_alt4.jpg)

## Related topics

* [Architecture layers overview]({{page.baseurl}}/architecture/layers.html)
