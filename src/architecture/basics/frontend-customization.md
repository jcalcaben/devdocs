...
redirect_from: /guides/v2.3/architecture/frontend_custom_strategies.html
---

## Overview {#m2arch-whatis-overview}

The Magento {% glossarytooltip b00459e5-a793-44dd-98d5-852ab33fc344 %}frontend{% endglossarytooltip %} is designed to optimize {% glossarytooltip 1a70d3ac-6bd9-475a-8937-5f80ca785c14 %}storefront{% endglossarytooltip %} customization, with highly extensible _themes_ being the central customization mechanism.
...
* [Magento UI Library Components]({{page.baseurl}}/ui-components.html)

* [Magento Admin Pattern Library]({{page.baseurl}}/pattern-library.html)

See the [Frontend Developer Guide]({{page.baseurl}}/frontend-development.html) for information on creating your themes.
...
See [Magento UI Library Components]({{page.baseurl}}/ui-components.html) for details about this library.

### Magento Admin pattern library

A _pattern library_ is a collection of user interface (UI) design patterns that can be re-used in locations throughout your product installation. The [Magento Admin Pattern Library]({{page.baseurl}}/pattern-library.html) defines examples of components that administrators working with the storefront can use.
...
See [Magento Admin Pattern Library]({{page.baseurl}}/pattern-library.html) for more information on using this library.

## Related topics {#m2arch-related}

[Extensibility and modularity]({{page.baseurl}}/architecture/basics/extensibility.html)

[Global extensibility features]({{page.baseurl}}/architecture/basics/global-extensibility-features.html)
