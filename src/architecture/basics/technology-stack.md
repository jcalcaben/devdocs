...
redirect_from: /guides/v2.3/architecture/tech-stack.html
---
...
For more information, see the [Functional Testing Framework]({{page.baseurl}}/testing/functional-testing-framework/introduction.html) guide.
