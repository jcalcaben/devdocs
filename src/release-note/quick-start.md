...
* **Install the Beta code**. See [2.3.0 Installation Guide]({{page.baseurl}}/release-notes/install.html) for complete instructions for downloading and installing Alpha code.
...
Ready to [install]({{page.baseurl}}/release-notes/install.html) Magento 2.3.0  Beta?
